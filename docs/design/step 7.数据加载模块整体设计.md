...
┌─────────────────────────────────────────────────────────────┐
│                     CLI 层 (用户接口)                         │
│  python -m metaweave.cli.main load --type xxx --config   │
└─────────────────────┬───────────────────────────────────────┘
                      │
                      ▼
┌─────────────────────────────────────────────────────────────┐
...
```bash
python -m metaweave.cli.main load --type <TYPE> [--config <CONFIG_FILE>] [--debug]
```
...
# 加载 CQL（指定配置文件）
python -m metaweave.cli.main load --type cql --config my_loader_config.yaml

# 加载 MD 到向量数据库（未来实现后可用）
python -m metaweave.cli.main load --type md --debug
...
```bash
# 加载所有类型
python -m metaweave.cli.main load --type all
```
