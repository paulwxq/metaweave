...
# 执行 json_llm
python -m metaweave.cli.main metadata --step json_llm --tables employee
...
**验证**：
```bash
python -m metaweave.cli.main metadata --step json_llm --tables large_table
...
# 2. 执行
python -m metaweave.cli.main metadata --step json_llm
...
```bash
python -m metaweave.cli.main metadata --step json_llm
python -m metaweave.cli.main metadata --step cql_llm
