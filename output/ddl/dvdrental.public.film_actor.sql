...
COMMENT ON COLUMN public.film_actor.last_update IS '记录最后更新时间';

-- Indexes
CREATE INDEX idx_fk_film_id ON public.film_actor(film_id);

-- Table Comment
COMMENT ON TABLE public.film_actor IS '电影与演员关联表，记录演员参演电影的关系及最后更新时间';
