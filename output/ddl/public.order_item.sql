...
-- Column Comments
COMMENT ON COLUMN public.order_item.item_id IS '订单项唯一标识ID';
COMMENT ON COLUMN public.order_item.order_id IS '关联订单的唯一标识ID';
...
/* SAMPLE_RECORDS
{
  "version": 1,
  "table": "public.order_item",
  "generated_at": "2025-12-24T04:52:54.514514Z",
  "records": [
    {
      "label": "Record 1",
      "data": {
