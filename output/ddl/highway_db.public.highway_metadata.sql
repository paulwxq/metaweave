...
COMMENT ON COLUMN public.highway_metadata.questions IS '常见业务问题及对应SQL查询示例';
COMMENT ON COLUMN public.highway_metadata.keywords IS '主题关联的核心业务关键词数组';
COMMENT ON COLUMN public.highway_metadata.theme_tag IS '主题所属分析大类标签';
COMMENT ON COLUMN public.highway_metadata.update_ts IS '元数据最后更新时间戳';
